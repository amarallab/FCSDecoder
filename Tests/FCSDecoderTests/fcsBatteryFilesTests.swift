...
final class FCSBatteryFilesTests: XCTestCase {
    ...
    private func test(resource: String) throws {
        ...
        let _ = try FCS(from: data)
        let elapsedTime = Date().timeIntervalSince(beginData)
        print("\tRead in \(elapsedTime) seconds")
    }
    
// TODO: These files are 16 bits Int and there are not allowed
...
//    }
    ...
    // TODO: This file is 16 bits Int and there are not allowed
